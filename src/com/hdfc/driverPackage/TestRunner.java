...
String Udata;
	...
	public void initializeDriver() throws MalformedURLException{	
    	...
    	mobileCapablities.setCapability("UDID", getConfigProperty("DeviceUDID"));
    	...
    	nativeDriver=new AndroidDriver(new URL(ConstantClass.Address_Port),mobileCapablities);
	...
	public String getTestData(String Uname, String TCID){
		...
		int ColumnIndex = readr.readHeaderIndex("C:\\WorkSpace\\mobileHDFCDemo\\MasterTestData.xlsx","Data", Uname);
		Udata=readr.readXLatIndex("C:\\WorkSpace\\mobileHDFCDemo\\MasterTestData.xlsx","Data",TCID,ColumnIndex);
		return Udata;	
